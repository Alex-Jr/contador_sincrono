...
ENTITY 	contador IS
	...
	clock : IN std_logic;
	switch : IN std_logic;
	LED00_out : BUFFER std_logic_vector(0 TO 6);
	LED01_out : BUFFER std_logic_vector(0 TO 6);
	LED10_out : BUFFER std_logic_vector(0 TO 6);
	LED11_out : BUFFER std_logic_vector(0 TO 6)
	);
END contador;
